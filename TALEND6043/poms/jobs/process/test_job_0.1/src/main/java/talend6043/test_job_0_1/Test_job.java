...
package talend6043.test_job_0_1;
...
public class Test_job implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Test_job.log");
	}
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_iWLwIJSBEfCtufhT2-fFUw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-09-18T11:22:22.445653600Z");
		...
		try {
			...
			java.io.InputStream inContext = Test_job.class.getClassLoader()
					.getResourceAsStream("talend6043/test_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 50811 characters generated by Talend Cloud Data Management Platform on the
 * September 18, 2025 at 4:52:22 PM IST
 ************************************************************************************************/
...
package talend6043.testjob1_0_1;
 ...
 * @status
 */
public class TestJob1 implements TalendJob {
	...
	private final String jobName = "TestJob1";
	private final String projectName = "TALEND6043";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				TestJob1.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TestJob1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final TestJob1 TestJob1Class = new TestJob1();

		int exitCode = TestJob1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TestJob1.class.getClassLoader()
					.getResourceAsStream("talend6043/testjob1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TestJob1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TestJob1");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 46315 characters generated by Talend Cloud Data Management Platform on the
 * September 18, 2025 at 5:14:04 PM IST
 ************************************************************************************************/
...
/**
 * Job: jobtoprint Purpose: <br>
 * Description:  <br>
 * @author R, lata
 * @version 8.0.1.20250730_0900-patch
 * @status 
 */
public class jobtoprint implements TalendJob {
	static {System.setProperty("TalendJob.log", "jobtoprint.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(jobtoprint.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "jobtoprint";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_RpN20JRxEfCsDZ1M1R1oIw", "0.1");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			jobtoprint.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jobtoprint.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
String foo = "bar";
System.out.println("Hello Talend 8");
 ...
 */
    ...
    public static void main(String[] args){
        final jobtoprint jobtoprintClass = new jobtoprint();

        int exitCode = jobtoprintClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'jobtoprint' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'jobtoprint' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_RpN20JRxEfCsDZ1M1R1oIw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-09-18T09:29:05.489057900Z");
        ...
        try {
            ...
            java.io.InputStream inContext = jobtoprint.class.getClassLoader().getResourceAsStream("talend/jobtoprint_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jobtoprint.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'jobtoprint' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jobtoprint");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'jobtoprint' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     50844 characters generated by Talend Cloud Data Management Platform 
 *     on the September 18, 2025 at 2:59:05 PM IST
 ************************************************************************************************/
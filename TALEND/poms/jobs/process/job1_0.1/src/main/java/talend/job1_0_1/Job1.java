...
public class Job1 implements TalendJob {
	...
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Job1.class);
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_jMo7MJR6EfCsDZ1M1R1oIw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-09-18T10:39:57.129943900Z");
		...
		try {
			...
			java.io.InputStream inContext = Job1.class.getClassLoader()
					.getResourceAsStream("talend/job1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
		...
		log.info("TalendJob: 'Job1' - Started.");
		...
		log.info("TalendJob: 'Job1' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 50723 characters generated by Talend Cloud Data Management Platform on the
 * September 18, 2025 at 4:09:57 PM IST
 ************************************************************************************************/